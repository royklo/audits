...
$allTenantsAverageScore = ($secureScoreLatest.AverageComparativeScores | Where-Object { $_.Basis -eq "AllTenants" }).AverageScore
$allTenantsAverageIdentity = ($secureScoreLatest.AverageComparativeScores | Where-Object { $_.Basis -eq "AllTenants" }).identityScore
$allTenantsAverageApps = ($secureScoreLatest.AverageComparativeScores | Where-Object { $_.Basis -eq "AllTenants" }).appsScore
$allTenantsAverageDevice = ($secureScoreLatest.AverageComparativeScores | Where-Object { $_.Basis -eq "AllTenants" }).deviceScore
$allTenantsAverageData = ($secureScoreLatest.AverageComparativeScores | Where-Object { $_.Basis -eq "AllTenants" }).dataScore
$TotalSeatsAverageScore = ($secureScoreLatest.AverageComparativeScores | Where-Object { $_.Basis -eq "TotalSeats" }).AverageScore
$TotalSeatsAverageIdentity = ($secureScoreLatest.AverageComparativeScores | Where-Object { $_.Basis -eq "TotalSeats" }).identityScore
$TotalSeatsAverageApps = ($secureScoreLatest.AverageComparativeScores | Where-Object { $_.Basis -eq "TotalSeats" }).appsScore
$TotalSeatsAverageDevice = ($secureScoreLatest.AverageComparativeScores | Where-Object { $_.Basis -eq "TotalSeats" }).deviceScore
$TotalSeatsAverageData = ($secureScoreLatest.AverageComparativeScores | Where-Object { $_.Basis -eq "TotalSeats" }).dataScore
...
$controlCategoryTable = $DetailedControlScoresTable | Group-Object ControlCategory | ForEach-Object {
